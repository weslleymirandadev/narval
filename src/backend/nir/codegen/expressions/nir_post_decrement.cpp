...
void PostDecrementExprNode::nir_codegen(nv::NIRGenerationContext& ctx) {
    ...
    auto next = nir_call_runtime(ctx, loc, "nv_sub", {old_val, one}, {vt});
    ...
    // Post-decrement: push the old value (before decrement).
