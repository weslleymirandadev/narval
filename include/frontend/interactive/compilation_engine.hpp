...
private:
    ...
    bool compile_expression(std::unique_ptr<Node>& ast, const std::unordered_set<std::string>& defined_this_line, const std::unordered_set<std::string>& used_this_line, const std::vector<std::string>& slot_names);
