...
static void json_dump_nv_array(const NVArray* a, FILE* out, int depth) {
    if (!a) {
        fputs("null", out);
        return;
    }
...
static void json_dump_nv_vector(const NVVector* vec, FILE* out, int depth) {
    if (!vec) {
        fputs("null", out);
        return;
    }
...
static void json_dump_nv_map(const NVMap* m, FILE* out, int depth) {
    if (!m) {
        fputs("null", out);
        return;
    }
...
static void json_dump_nv_tuple(const NVTuple* t, FILE* out, int depth) {
    if (!t) {
        fputs("null", out);
        return;
    }
